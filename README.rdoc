...
Configuration Option 2:  pass in non-default configurations as a hash
...
Configuration Option 3:  set the attributes explicitly in your code
...
Configuration Option 4:  set the OAI parameters as params in call to Harvestdor::Client.harvest_xx
